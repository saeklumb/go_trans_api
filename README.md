...
* **Как использовать:** Импортируйте этот файл в Postman (кнопка Import), и у вас появится готовый набор запросов для проверки Health Check, балансов и создания транзакций.
